...
const Stake: React.FC = () => {
  ...
  const [approveStatus, approve] = useApprove(sfiFinance.TSHARE, sfiFinance.contracts.Masonry.address);

  const tokenBalance = useTokenBalance(sfiFinance.TSHARE);
  const stakedBalance = useStakedBalanceOnMasonry();
  const { from, to } = useUnstakeTimerMasonry();

  const stakedTokenPriceInDollars = useStakedTokenPriceInDollars('TSHARE', sfiFinance.TSHARE);
